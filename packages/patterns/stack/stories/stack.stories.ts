...
export const Gaps: Story = {
  render: () => ({
    template: `
      <div style="display:flex;gap:32px;flex-wrap:wrap;font-family:Onest,system-ui,sans-serif;font-size:12px;color:#71717A">
...
export const Align: Story = {
  render: () => ({
    template: `
      <div style="display:flex;gap:32px;font-family:Onest,system-ui,sans-serif;font-size:12px;color:#71717A">
