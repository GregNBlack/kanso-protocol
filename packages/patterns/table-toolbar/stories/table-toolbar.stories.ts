...
export const Playground: Story = {
  ...
  render: (args) => ({
    props: args,
    template: `<div style="width:1100px;border:1px solid #E4E4E7;border-radius:8px;overflow:hidden"><kp-table-toolbar ${Object.keys(args).map(k => `[${k}]="${k}"`).join(' ')}></kp-table-toolbar></div>`,
  }),
};
  ...
  render: () => ({
    template: `
      <div style="display:flex;flex-direction:column;gap:24px;padding:24px">
        <div style="width:1100px;border:1px solid #E4E4E7;border-radius:8px;overflow:hidden">
