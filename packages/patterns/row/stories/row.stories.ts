...
export const Gaps: Story = {
  render: () => ({
    template: `
      <div style="display:flex;flex-direction:column;gap:16px;font-family:Onest,system-ui,sans-serif;font-size:12px;color:#71717A">
      ...
      <div style="display:flex;flex-direction:column;gap:16px;font-family:Onest,system-ui,sans-serif;font-size:12px;color:#71717A">
        ${['start','center','end','space-between','space-around'].map(j => `
          <div>
            ...
            <div style="background:#FAFAFA;padding:12px;border-radius:6px;width:600px">
      ...
      <div style="display:flex;flex-direction:column;gap:16px;font-family:Onest,system-ui,sans-serif;font-size:12px;color:#71717A">
        ${['start','center','end','stretch','baseline'].map(a => `
          <div>
            ...
            <div style="background:#FAFAFA;padding:12px;border-radius:6px;height:100px">
  ...
  render: () => ({
    template: `
      <div style="display:flex;flex-direction:column;gap:24px;font-family:Onest,system-ui,sans-serif">
        <div>
          <div style="font-size:12px;color:#71717A;margin-bottom:6px">Button group (justify=end)</div>
          <div style="background:#FAFAFA;padding:12px;border-radius:6px;width:600px">
            <kp-row gap="sm" justify="end">
              <button style="padding:8px 16px;background:#fff;border:1px solid #E4E4E7;border-radius:6px">Cancel</button>
              <button style="padding:8px 16px;background:#2563EB;color:#fff;border:none;border-radius:6px">Save</button>
            </kp-row>
          </div>
        </div>
        <div>
          <div style="font-size:12px;color:#71717A;margin-bottom:6px">Header (justify=space-between)</div>
          <div style="background:#FAFAFA;padding:12px;border-radius:6px;width:600px">
