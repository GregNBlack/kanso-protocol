  ...
  render: () => ({
    template: `
      <div style="display:flex;align-items:flex-start;gap:24px;flex-wrap:wrap">
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px"><kp-badge size="xs">Badge</kp-badge><span style="font-size:11px;color:#A1A1AA">xs</span></div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px"><kp-badge size="sm">Badge</kp-badge><span style="font-size:11px;color:#A1A1AA">sm</span></div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px"><kp-badge size="md">Badge</kp-badge><span style="font-size:11px;color:#A1A1AA">md</span></div>
      </div>`,
  }),
};
  ...
  render: () => ({
    template: `
      <div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap">
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px"><kp-badge appearance="filled">Primary</kp-badge><span style="font-size:11px;color:#A1A1AA">Filled</span></div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px"><kp-badge appearance="subtle">Primary</kp-badge><span style="font-size:11px;color:#A1A1AA">Subtle</span></div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px"><kp-badge appearance="outline">Primary</kp-badge><span style="font-size:11px;color:#A1A1AA">Outline</span></div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px"><kp-badge appearance="dot">Primary</kp-badge><span style="font-size:11px;color:#A1A1AA">Dot</span></div>
      </div>`,
  }),
};
  ...
  render: () => ({
    template: `
      <div style="display:flex;align-items:center;gap:24px">
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px"><kp-badge appearance="subtle">Rounded</kp-badge><span style="font-size:11px;color:#A1A1AA">Rounded</span></div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px"><kp-badge appearance="subtle" [pill]="true">Pill</kp-badge><span style="font-size:11px;color:#A1A1AA">Pill</span></div>
      </div>`,
  }),
};
    ...
    template: `
      <div style="display:flex;flex-direction:column;gap:16px;align-items:flex-start">
        <div style="display:flex;align-items:center;gap:12px">
          <span style="font-size:12px;color:#71717A">User status:</span>
          <kp-badge appearance="dot" color="success">Online</kp-badge>
        </div>
        <div style="display:flex;align-items:center;gap:12px">
          <span style="font-size:12px;color:#71717A">Order #1234:</span>
          <kp-badge appearance="subtle" color="warning">Pending</kp-badge>
          <kp-badge appearance="subtle" color="info">Priority</kp-badge>
        </div>
        <div style="display:flex;align-items:center;gap:12px">
          <span style="font-size:12px;color:#71717A">Article tags:</span>
