...
- Updated dependencies
  ...
  - @kanso-protocol/select@3.0.2
  - @kanso-protocol/i18n@3.0.2
...
- Updated dependencies
  ...
  - @kanso-protocol/select@3.0.1
  - @kanso-protocol/i18n@3.0.1
...
- Updated dependencies
  ...
  - @kanso-protocol/select@2.0.2
  - @kanso-protocol/i18n@2.0.2
...
- Updated dependencies [2c9b5ca]
  ...
  - @kanso-protocol/select@1.0.0
  - @kanso-protocol/i18n@1.0.0

## 0.5.3

### Patch Changes

- @kanso-protocol/select@0.5.3
...
- @kanso-protocol/select@0.5.2
- @kanso-protocol/core@0.5.2
- @kanso-protocol/i18n@0.5.2
