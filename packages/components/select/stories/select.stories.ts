    ...
    template: `
      <div style="${ROOM};display:flex;gap:24px;align-items:flex-start;flex-wrap:wrap">
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          ...
          <span style="font-size:11px;color: var(--kp-color-gray-600)">Single · value: {{ single ?? '—' }}</span>
        </div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
    ...
    template: `
      <div style="${ROOM};display:flex;gap:24px;align-items:flex-start;flex-wrap:wrap">
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          ...
          <span style="font-size:11px;color: var(--kp-color-gray-600)">Single w/ value + clear</span>
        </div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          <kp-select [(ngModel)]="v2" [multiple]="true" [options]="tags" placeholder="Pick tags"></kp-select>
          <span style="font-size:11px;color: var(--kp-color-gray-600)">Multi w/ 2 values</span>
        </div>
      </div>`,
  }),
};
  ...
  render: () => ({
    ...
    template: `
      <div style="${ROOM};display:flex;flex-direction:column;gap:32px">
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-start;gap:6px">
          <span style="font-size:10px;color: var(--kp-color-gray-600);text-transform:uppercase;letter-spacing:.06em">LG · Single · Rest (label inside)</span>
          <kp-select size="lg" [floatingLabel]="true" label="Country" [options]="options" [(ngModel)]="vSingleEmpty"></kp-select>
        </div>

        <div style="display:flex;flex-direction:column;align-items:flex-start;gap:6px">
          <span style="font-size:10px;color: var(--kp-color-gray-600);text-transform:uppercase;letter-spacing:.06em">LG · Single · With value (label floated)</span>
          <kp-select size="lg" [floatingLabel]="true" label="Country" [options]="options" [(ngModel)]="vSingleFilled"></kp-select>
        </div>

        <div style="display:flex;flex-direction:column;align-items:flex-start;gap:6px">
          <span style="font-size:10px;color: var(--kp-color-gray-600);text-transform:uppercase;letter-spacing:.06em">XL · Multi · Rest (label inside)</span>
          <kp-select size="xl" [floatingLabel]="true" [multiple]="true" label="Tags" [options]="tags" [(ngModel)]="vMultiEmpty"></kp-select>
        </div>

        <div style="display:flex;flex-direction:column;align-items:flex-start;gap:6px">
          <span style="font-size:10px;color: var(--kp-color-gray-600);text-transform:uppercase;letter-spacing:.06em">XL · Multi · With values (label floated, "Selected N out of M")</span>
