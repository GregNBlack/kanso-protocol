    ...
    template: `
      <div style="display:flex;gap:16px;align-items:flex-start;padding:8px">
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          ...
          <span style="font-size:11px;color:#A1A1AA">sm / 28px items</span>
        </div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          <kp-dropdown-menu>
          ...
          <span style="font-size:11px;color:#A1A1AA">md / 32px items</span>
        </div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          <kp-dropdown-menu>
          ...
          <span style="font-size:11px;color:#A1A1AA">lg / 40px items</span>
        </div>
      </div>`,
  }),
};
