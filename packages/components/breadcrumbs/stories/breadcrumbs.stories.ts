...
@Component({
  ...
  template: `
    ...
    <p style="font-size:11px;color: var(--kp-color-gray-600);margin:12px 0 0">
...
export const Overflow: Story = {
  render: () => ({
    template: `
      ...
      <p style="font-size:11px;color: var(--kp-color-gray-600);margin:8px 0 0">Use ellipsis to collapse middle levels when path is long. Clicking ellipsis opens a Popover / DropdownMenu with hidden items.</p>`,
  }),
};
...
export const States: Story = {
  render: () => ({
    template: `
      ...
      <p style="font-size:11px;color: var(--kp-color-gray-600);margin:8px 0 0">Hover + focus states are interactive — move the mouse over "Rest" or tab into it.</p>`,
  }),
};
