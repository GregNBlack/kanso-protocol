    ...
    template: `
      <div style="display:flex;align-items:flex-end;gap:40px">
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          ...
          <span style="font-size:11px;color:#A1A1AA">sm</span>
        </div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          <kp-tooltip size="md" label="Tooltip text"/>
          <span style="font-size:11px;color:#A1A1AA">md</span>
        </div>
      </div>`,
  }),
};
    ...
    template: `
      <div style="display:flex;align-items:center;gap:60px;padding:24px 12px">
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          ...
          <span style="font-size:11px;color:#A1A1AA">None</span>
        </div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          <kp-tooltip arrowPosition="top"    label="Tooltip"/>
          <span style="font-size:11px;color:#A1A1AA">Top</span>
        </div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          <kp-tooltip arrowPosition="bottom" label="Tooltip"/>
          <span style="font-size:11px;color:#A1A1AA">Bottom</span>
        </div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          <kp-tooltip arrowPosition="left"   label="Tooltip"/>
          <span style="font-size:11px;color:#A1A1AA">Left</span>
        </div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
          <kp-tooltip arrowPosition="right"  label="Tooltip"/>
          <span style="font-size:11px;color:#A1A1AA">Right</span>
        </div>
      </div>`,
  }),
};
    ...
    template: `
      <div style="display:flex;align-items:flex-start;gap:48px;padding:24px 8px">
        <div style="display:flex;flex-direction:column;align-items:center;gap:4px">
          ...
          <div style="width:36px;height:36px;display:flex;align-items:center;justify-content:center;background:#F4F4F5;border-radius:12px">
